...
// Generated from this stereo_msgs_DisparityImage.msg definition:
...
#ifndef YARPMSG_TYPE_stereo_msgs_DisparityImage
#define YARPMSG_TYPE_stereo_msgs_DisparityImage
...
class stereo_msgs_DisparityImage : public yarp::os::idl::WirePortable {
public:
  std_msgs_Header header;
  sensor_msgs_Image image;
  yarp::os::NetFloat32 f;
  yarp::os::NetFloat32 T;
  sensor_msgs_RegionOfInterest valid_window;
  ...
  bool readBare(yarp::os::ConnectionReader& connection) YARP_OVERRIDE {
    ...
    // *** image ***
    if (!image.read(connection)) return false;

    // *** f ***
    if (!connection.expectBlock((char*)&f,4)) return false;

    // *** T ***
    if (!connection.expectBlock((char*)&T,4)) return false;

    // *** valid_window ***
    if (!valid_window.read(connection)) return false;

    // *** min_disparity ***
    if (!connection.expectBlock((char*)&min_disparity,4)) return false;

    // *** max_disparity ***
    if (!connection.expectBlock((char*)&max_disparity,4)) return false;

    // *** delta_d ***
    if (!connection.expectBlock((char*)&delta_d,4)) return false;
  ...
  bool writeBare(yarp::os::ConnectionWriter& connection) YARP_OVERRIDE {
    ...
    // *** image ***
    if (!image.write(connection)) return false;
    ...
    // *** valid_window ***
    if (!valid_window.write(connection)) return false;
  ...
  typedef yarp::os::idl::BareStyle<stereo_msgs_DisparityImage> rosStyle;
  typedef yarp::os::idl::BottleStyle<stereo_msgs_DisparityImage> bottleStyle;
